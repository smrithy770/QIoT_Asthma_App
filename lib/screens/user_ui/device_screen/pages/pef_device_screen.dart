...
class PEFDeviceScreen extends StatefulWidget {
  final BluetoothDevice device;

  const PEFDeviceScreen({Key? key, required this.device}) : super(key: key);

  @override
  State<PEFDeviceScreen> createState() => _DeviceScreenState();
}

class _DeviceScreenState extends State<PEFDeviceScreen> {
  int? _rssi;
  int? _mtuSize;
  ...
  Future<void> onRequestMtuPressed() async {
    try {
      ...
      CustomSnackBarUtil.showCustomSnackBar("Request Mtu: Success",
          success: true);
    } catch (e) {
      CustomSnackBarUtil.showCustomSnackBar("Change Mtu Error: $e",
          success: false);
    }
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  SizedBox(
                    ...
                    child: Text(
                      'Peakflow device is ${_connectionState.toString().split('.')[1]}.',
