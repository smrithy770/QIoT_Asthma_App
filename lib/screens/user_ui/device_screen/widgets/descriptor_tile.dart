...
class _DescriptorTileState extends State<DescriptorTile> {
  ...
  Future onReadPressed() async {
    try {
      await d.read();
      CustomSnackBarUtil.showCustomSnackBar("Descriptor Read : Success",
          success: true);
    } catch (e) {
      CustomSnackBarUtil.showCustomSnackBar("Descriptor Read Error: $e",
          success: false);
    }
  }
  ...
  Future onWritePressed() async {
    try {
      ...
      CustomSnackBarUtil.showCustomSnackBar("Descriptor Write : Success",
          success: true);
    } catch (e) {
      CustomSnackBarUtil.showCustomSnackBar("Descriptor Write Error: $e",
          success: false);
    }
  }
